    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] group-hover/pin:shadow-[0_20px_40px_rgba(168,85,247,0.5)] bg-black border border-white/[0.1] group-hover/pin:border-primary/50 transition duration-700 overflow-hidden"
        >
          <div className={cn(" relative z-50 ", className)}>{children}</div>
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/pin:opacity-100 transition-opacity duration-500 pointer-events-none" />
        </div>
      </div>
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2  h-[11.25rem] w-[11.25rem] rounded-[50%] bg-primary/[0.3] shadow-[0_8px_16px_rgba(168,85,247,0.4)]"
            ></motion.div>
            <motion.div
              initial={{
                opacity: 0,
